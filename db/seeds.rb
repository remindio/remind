...
seila = Note.create(title: "ALOALO", description: "GALERA DE COWBOY", environment_id: 2)
aloalo = Note.create(title: "OLAOLA", description: "GALERA DE COWBOY", environment_id: 2)
task1 = TaskList.create(title: "seila", environment_id: 2)
task2 = TaskList.create(title: "maisumatask", environment_id: 2)
taskitem1 = TaskListItem.create(description: "MEU DEUS ME ELIMINA", task_list_id: 3, task_completed?: false)
taskitem2 = TaskListItem.create(description: "MEU DEUS ME AJUDA", task_list_id: 3, task_completed?: false)
taskitem3 = TaskListItem.create(description: "MEU DEUS ME SENHOR", task_list_id: 4, task_completed?: true)

seila = Note.create(title: "ALOALO", description: "GALERA DE COWBOY", environment_id: 3)
aloalo = Note.create(title: "OLAOLA", description: "GALERA DE COWBOY", environment_id: 3)
task1 = TaskList.create(title: "seila", environment_id: 3)
task2 = TaskList.create(title: "maisumatask", environment_id: 3)
taskitem1 = TaskListItem.create(description: "MEU DEUS ME ELIMINA", task_list_id: 5, task_completed?: false)
taskitem2 = TaskListItem.create(description: "MEU DEUS ME AJUDA", task_list_id: 5, task_completed?: false)
taskitem3 = TaskListItem.create(description: "MEU DEUS ME SENHOR", task_list_id: 6, task_completed?: true)